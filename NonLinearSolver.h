...
public:
    ...
    static double newton(std::function<double(double)> f, std::function<double(double)> fd, double xInitial, double epsilon, int maxStep, std::function<void(int, double)> onValueUpdate);
